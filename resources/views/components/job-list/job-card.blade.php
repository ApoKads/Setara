    ...
    <div
        ...
        <div>
            <div class="h-40 flex items-center justify-center bg-red object-cover bg-blue-200">
                ...
                {{-- @if ($card->path_banner)
                <img src="{{ asset('storage/' . $card->path_banner) }}" alt="BCA Logo"
            ...
            <div class="px-5 pb-5 pt-4">
                ...
                <div class="flex items-center space-x-2 mb-3 font-pop">
                    <img src="{{ asset('storage/company/logoCompany.png') }}" alt="Company Logo"
                        class="w-20 h-20 rounded-full border-2 border-gray-200 object-contain">
                    <div class="flex flex-col gap-1">
                        ...
                        <p class="text-sm text-gray-500 flex items-center mt-0.5 -ml-0.5">
                            <svg class="w-4 h-4 mr-0.5 text-gray-400 font-pop" fill="currentColor" viewBox="0 0 20 20"
                ...
                <div class="flex flex-col gap-2 ml-2 mt-4">
                    <div class=" flex flex-wrap gap-2 max-h-[5rem] overflow-hidden relative mb-2">
                        <!-- Tag-tag Anda -->
                        <span
                            class="bg-[#C4DDF6] text-[#132442] text-[14px] font-medium rounded-sm flex px-2 py-1.5">{{ $card->JobType->name }}</span>
                        <span
                            class="bg-[#C4DDF6] text-[#132442] text-[14px] font-medium rounded-sm flex px-2 py-1.5">{{ $card->EducationLevel->name }}</span>
                        <span
                            class="bg-[#C4DDF6] text-[#132442] text-[14px] font-medium rounded-sm flex px-2 py-1.5">{{ $card->work_mode }}</span>
                        <span
                            class="bg-[#C4DDF6] text-[#132442] text-[14px] font-medium rounded-sm flex px-2 py-1.5">{{ $card->seniority->name }}</span>
                    </div>
                    <h1 class="">
