                ...
                <div class="px-5 pb-5 pt-4">
                    ...
                    <div class="flex items-center space-x-2 mb-3 font-pop">
                        ...
                        <div class="flex flex-col gap-1">
                            <h3 class="text-sm font-pop font-medium text-[#366FB6]">PT JAYA ABADI</h3>
                            <h3 class="text-xl font-pop font-medium text-gray-900">Sales Marketing</h3>
                    ...
                    <div class="flex flex-col gap-2 ml-2">
                        <div class="bg-red-300 flex flex-wrap gap-2 max-h-[5rem] overflow-hidden relative">
                            <!-- Tag-tag Anda -->
                            <span class="bg-[#C4DDF6] text-[#132442] text-sm font-semibold rounded-sm flex px-2.5 py-2">Full-Time</span>
                            <span class="bg-[#C4DDF6] text-[#132442] text-sm font-semibold rounded-sm flex px-2.5 py-2">Full-Time</span>
                            <span class="bg-[#C4DDF6] text-[#132442] text-sm font-semibold rounded-sm flex px-2.5 py-2">Full-Time</span>
                            <span class="bg-[#C4DDF6] text-[#132442] text-sm font-semibold rounded-sm flex px-2.5 py-2">Full-Time</span>
                            <span class="bg-[#C4DDF6] text-[#132442] text-sm font-semibold rounded-sm flex px-2.5 py-2">Full-Time</span>
                            ...
                            <!-- Overlay untuk ellipsis -->
                            <div class="absolute bottom-0 right-0 bg-gradient-to-l from-red-300 to-transparent w-10 h-6 flex items-center justify-end pr-1">
                                <span class="text-[#132442] font-bold">...</span>
                            </div>
                        </div>
                        test
                    </div>
