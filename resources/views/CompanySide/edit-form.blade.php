            ...
            <form action="{{ route('job.update', $job->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-6">
                    ...
                    <div class="relative">
                        <select id="work_mode" name="work_mode"
                            ...
                            <option value="Onsite & Remote" {{ old('work_mode', $job->work_mode) == 'Onsite & Remote' ? 'selected' : '' }}>Onsite & Remote</option>
                            <option value="Onsite" {{ old('work_mode', $job->work_mode) == 'Onsite' ? 'selected' : '' }}>Onsite</option>
                ...
                <div class="mb-6">
                    ...
                    <textarea id="description" name="description" placeholder="Deskripsi Pekerjaan" rows="6"
                        class="shadow appearance-none border rounded w-full py-3 px-4 text-gray-700 leading-tight focus:outline-none focus:shadow-outline resize-none text-lg @error('description') border-red-500 @enderror">{{ old('description', $job->description) }}</textarea>
                    @error('description')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mb-6">
                    ...
                    <textarea id="responsibilities" name="responsibilities" placeholder="Tanggung Jawab Pekerjaan" rows="6"
                        class="shadow appearance-none border rounded w-full py-3 px-4 text-gray-700 leading-tight focus:outline-none focus:shadow-outline resize-none text-lg @error('responsibilities') border-red-500 @enderror">{{ old('responsibilities', $job->responsibilities) }}</textarea>
                ...
                <div class="mb-6">
                    ...
                    @if ($job->banner_image_path)
                        <div class="mb-4">
                            ...
                            <img src="{{ asset($job->banner_image_path) }}" alt="Current Banner" class="max-w-xs h-auto rounded-lg shadow-md">
                        </div>
                    @endif
