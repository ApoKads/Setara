...
@section('content')
  ...
  <div class="position-absolute w-100 h-100 top-0 start-0 overflow-hidden z-n1 bg-red">
    <img src="{{ asset('images/CompanyDashboard/ParallaxAtas.png') }}" alt="Parallax Atas" class="position-fixed"
    style="top: -200px; right: -200px;">
    <img src="{{ asset('images/CompanyDashboard/ParallaxBawah.png') }}" alt="Parallax Bawah" class="position-fixed"
  ...
  <div class="container my-5 position-relative">
    ...
    <div class="dropdown">
      ...
      <li><button class="dropdown-item bg-white text-dark" name="sort" value="latest" type="submit">Terbaru</button>
      </li>
      <li><button class="dropdown-item bg-white text-dark" name="sort" value="oldest" type="submit">Terlama</button>
      </li>
      </ul>
    </div>
    ...
    <table class="table border-0 align-middle" style="border-collapse: separate; border-spacing: 0 15px;">
      ...
      <div class="d-flex align-items-center gap-2">
        ...
        onsubmit="return confirm('Yakin ingin menghapus Company ini?')" class="m-0 p-0">
        @csrf
        @method('DELETE')
        <button type="submit" class="d-flex justify-content-center align-items-center rounded-circle border-0"
