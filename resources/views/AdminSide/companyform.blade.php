...
@section('content')
    ...
    <body class="form-page-bg">
        <div class="container py-5 form-container">
            ...
            <form action="{{ $isEdit ? route('company.update', $company->id) : route('company.store') }}" method="POST"
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="website" class="form-control" placeholder="Masukkan link website (Opsional)"
                        ...
                        <select name="kota" id="kotaDropdown" class="form-select" required>
                            ...
                            @foreach ($locations as $lokasi)
                                @if ($selectedProvince === $lokasi->province)
                                    <option value="{{ $lokasi->city }}" {{ $selectedCity == $lokasi->city ? 'selected' : '' }}>
                                        {{ $lokasi->city }}
                                    </option>
                                @endif
                            @endforeach
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="kode_pos" class="form-control" placeholder="Masukkan kode pos (5 digit)"
                ...
                <div class="row mb-3 mt-2">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="npwp" class="form-control" placeholder="Masukkan NPWP (16 digit)"
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        @if($isEdit && $company->akta)
                            <a href="{{ asset('storage/' . $company->akta) }}" target="_blank" class="d-block mb-2">Lihat file
                                saat ini</a>
                        @endif
                    ...
                    <div class="col-md-6">
                        ...
                        @if($isEdit && $company->tdp)
                            <a href="{{ asset('storage/' . $company->tdp) }}" target="_blank" class="d-block mb-2">Lihat file
                                saat ini</a>
                        @endif
                ...
                <div class="row mb-4">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="nama_hrd" class="form-control" placeholder="Masukkan nama HRD"
                ...
                <div class="mb-3">
                    ...
                    <textarea name="deskripsi" class="form-control" rows="4" placeholder="Masukkan deskripsi perusahaan"
                        required>{{ old('deskripsi', $isEdit ? $company->description : '') }}</textarea>
                        ...
                        @foreach ($categories as $category)
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="categories[]"
                                    id="category{{ $category->id }}" value="{{ $category->id }}" {{ (is_array(old('categories')) && in_array($category->id, old('categories'))) || ($isEdit && $company->categories->contains($category->id)) ? 'checked' : '' }}>
