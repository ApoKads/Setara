                ...
                <div class="flex flex-col md:flex-row items-center gap-8">
                    ...
                    <div class="w-full md:w-2/3 text-center md:text-left">
                        ...
                        <div class="flex items-center justify-center md:justify-start gap-5 mt-8">
                            {{-- Mail --}}
                            <a href="mailto:{{ $user->email }}" class="text-blue-300 hover:text-white transition-colors"
                                title="Mail">
                            ...
                            {{-- Instagram --}}
                            <a href="#" class="text-blue-300 hover:text-white transition-colors" title="Instagram">
                                <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                                    <path
